  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button type="primary" @click="openDialog">新增日程概览</el-button>
        </el-form-item>
        <el-form-item>
    ...
    >
      ...
      <el-table-column label="上课时间" prop="ctime" width="120" /> <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateSchedule(scope.row)">变更</el-button>
...
export default {
  ...
  // 条件搜索前端看此方法
    ...
    async updateSchedule(row) {
      const res = await findSchedule({ ID: row.ID })
      this.type = 'update'
      if (res.code === 0) {
